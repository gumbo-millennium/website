...
$color = match($color) {
  ...
  'danger' => 'text-dark border-red-500 bg-transparent hover:bg-red-50 hover:border-red-600',
  'white' => 'text-brand-600 border-transparent bg-white hover:bg-brand-50',
  default => 'text-dark border-gray-500 bg-transparent hover:bg-gray-50 hover:border-gray-600',
};
$size = match($size) {
