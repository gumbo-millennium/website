...
.sponsor--backdrop-brand {
    background-image: url('{{ image_asset($sponsor->cover)->preset('banner') }}');
}
</style>
{{-- Actual sponsor --}}
<div class="sponsor sponsor--backdrop sponsor--backdrop-brand">
    <div class="container sponsor__container sponsor__container--modern">
        <div class="sponsor__card">
            ...
            {{-- Button --}}
            <a href="{{ route('sponsors.link', $sponsor) }}" target="_blank" rel="noopener" class="btn btn--brand sponsor__card-btn">
                Bekijk sponsor
            </a>
        </div>
    </div>
