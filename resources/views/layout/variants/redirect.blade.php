...
<div class="container container-sm payment-redirect">
    <div class="payment-redirect__logo" role="presentation">
        <img src="{{ Vite::image('images/logo-text-green.svg') }}" alt="Gumbo Millennium" class="payment-redirect__logo-image block dark:hidden"
            width="250" height="100" />
        <img src="{{ Vite::image('images/logo-text-night.svg') }}" alt="Gumbo Millennium" class="payment-redirect__logo-image hidden dark:block"
            width="250" height="100" />
    </div>
