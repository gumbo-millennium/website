...
$startFormat = $activity->start_date->month !== $activity->end_date->month ? $endFormat : 'dddd D';
@endphp
...
<div class="mb-4">
    ...
    <p class="mb-2 leading-relaxed">
        Om het voor jou en ons zo makkelijk mogelijk te maken, vragen wij je om direct de kosten voor deelname (á {{ Str::price($ticket->total_price) }}) te betalen.
