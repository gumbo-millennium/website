...
<div class="shop-header">
    ...
    <div class="shop-header-body-wrapper">
        <div class="container shop-header-body p-4 md:p-8 flex flex-col md:flex-row items-stretch">
            <div class="flex flex-col flex-grow">
                ...
                <h3
                    class="shop-header-title md:mb-4 lg:mb-8 font-title font-bold text-brand-primary-1 text-5xl lg:text-8xl">
