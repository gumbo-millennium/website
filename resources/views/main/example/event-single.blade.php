            ...
            <div class="col-lg-8">
                ...
                <article class="post">
                    ...
                    <div class="date-title">
                        <div class="date-block with-border">
                            <div class="date-number">24</div>
                            <div class="date-month">JAN</div>
                        </div>
                        <div class="date-body post-header">
                            <h1 class="post-title">Green Land Sport Season</h1>
                        ...
                        <div class="comment">
                            ...
                            <div class="comment-body">
                                <div class="comment-meta">
                                    <div class="comment-meta-author h5"><a href="#">Jason Ford</a></div>
                                    <div class="comment-meta-date"><a href="#">
                                        <time datetime="2015-05-05T04:51:41+00:00">May 5, 2015 at 4:51 am</time></a></div>
                                    </div>
                                    <div class="comment-content">
                                        <p>Certainty determine at of arranging perceived situation or. Or wholly pretty county in oppose. Favour met itself wanted settle put garret twenty. In astonished apartments resolution so an it. Unsatiable on by contrasted to reasonable companions an.</p>
                                    </div>
                                ...
                                <div class="children">
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="comment-meta">
                                                <div class="comment-meta-author h5"><a href="#">Harry Benson</a></div>
                                                <div class="comment-meta-date"><a href="#">
                                                    <time datetime="2015-05-05T04:51:41+00:00">May 5, 2015 at 4:51 am</time></a></div>
                                                </div>
                                                <div class="comment-content">
                                                    <p>Made last it seen went no just when of by. Occasional entreaties comparison me difficulty so themselves. At brother inquiry of offices without do my service. As particular to companions at sentiments.</p>
                                                </div>
                                                <div class="comment-reply"><a href="#">Reply</a></div>
                                            </div>
                                        </div>
                                ...
                                <div class="comment">
                                    ...
                                    <div class="comment-body">
                                        <div class="comment-meta">
                                            <div class="comment-meta-author h5"><a href="#">Henry Cain</a></div>
                                            <div class="comment-meta-date"><a href="#">
                                                <time datetime="2015-05-05T04:51:41+00:00">May 5, 2015 at 4:51 am</time></a></div>
                                            </div>
                                            <div class="comment-content">
                                ...
                                <div class="comment-respond">
                                    ...
                                    <form class="comment-form row">
                                        ...
                                        <div class="form-submit col-sm-12">
                                            <input class="btn btn-round btn-brand" type="submit" value="Post Comment">
                                        </div>
                                    </form>
                                </div>
                            </div>
