<x-mail::message>
  ...
  Je hebt op {{ $user->created_at->isoFormat('d M Y') }} een account op de Gumbo Millennium website ([gumbo-millennium.nl](https://www.gumbo-millennium.nl)) aangemaakt.
  Volgens onze gegevens heb je deze voor het laatst gebruikt op {{ $user->last_seen_at->isoFormat('d M Y') }}, en is die dus stof aan het verzamelen.
