    ...
    <div class="container container--md">
        ...
        <article class="sponsor-single__container">
            ...
            <header class="sponsor-single__header">
                ...
                {{-- Button bit --}}
                <a href="{{ route('sponsors.link', compact('sponsor')) }}" class="btn btn--brand sponsor-single__header-button">
                    Lees meer
                </a>
            </header>
            ...
            <div class="sponsor-single__footer">
                ...
                <a href="{{ route('sponsors.link', compact('sponsor')) }}" class="btn btn--brand sponsor-single__footer-button">
                    Lees meer
                </a>
            </div>
        </article>
