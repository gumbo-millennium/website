...
return [
    ...
    */
    'custom' => [
        ...
        'location_address' => [
            'required_unless' => 'Tenzij dit een "alleen online" activieit is, moet je het adres van de locatie opgeven.',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'discount_count'        => 'aantal kortingen',
        'duration'              => 'tijdsduur',
        'email'                 => 'e-mailadres',
        'end_date'              => 'einddatum',
        'enrollment_end'        => 'sluiting inschrijvingen',
        'enrollment_start'      => 'opening inschrijvingen',
        'excerpt'               => 'uittreksel',
        'first_name'            => 'voornaam',
        'gender'                => 'geslacht',
        'group'                 => 'groep',
        ...
        'lesson'                => 'les',
        'location_address'      => 'adres locatie',
        'location_type'         => 'locatietype',
        'location'              => 'locatie',
        'member_discount'       => 'ledenkorting',
        'message'               => 'bericht',
        'minute'                => 'minuut',
        'mobile'                => 'mobiel',
        'month'                 => 'maand',
        ...
        'price'                 => 'prijs',
        'role'                  => 'groep',
        'seats'                 => 'aantal plekken',
        'second'                => 'seconde',
        'sex'                   => 'geslacht',
        'size'                  => 'grootte',
        'slug'                  => 'path',
        'start_date'            => 'startdatum',
        'statement'             => 'incasso omschrijving',
        'street'                => 'straatnaam',
        'student'               => 'student',
        'subject'               => 'onderwerp',
        'tagline'               => 'slagzin',
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used by Laravel Nova.
    |
    */
    'attached' => ':attribute is al gekoppeld.',
    'relatable' => ':attribute kan niet geassocieerd worden met deze bron.',
];
