...
class GoogleMailList implements MailList, JsonSerializable
{
    ...
    public static function fromGoogleModel(Google_Service_Directory_Group $group, Google_Service_Directory_Members $members): self
    {
        $users = [];
     ...
     */
    public function __construct(string $email, string $serviceId, array $members, array $aliases, array $lockedAliases)
    {
        // Check email
