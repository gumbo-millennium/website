...
return [
    'defaults' => [
        ...
        'field_class' => 'form__field-input shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md',
        ...
        'error_class' => 'form__field-error mt-2 text-sm text-red-600',
        'required_class' => '',
